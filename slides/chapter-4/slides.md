...
一个名为 `my_topic`、两个分区的 Topic，其日志由 `my_topic_0` 和 `my_topic_1` 两个文件夹组成；每个文件夹里是一系列日志实体，每个实体是“4 字节长度整数 N + N 字节消息”。

![日志文件示意图](./assets/figures/log-segment-files.png){fit="contain" position="center" max-height="50vh"}
