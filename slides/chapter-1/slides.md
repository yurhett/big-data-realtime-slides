...
![消息队列模型](./assets/figures/message-queue-model.png){fit="contain" position="center" max-height="46vh"}
...
![消息传递与获取](./assets/figures/message-passing-worker.png){fit="contain" position="center" max-height="46vh"}
...
![Storm 计算模型](./assets/figures/storm-computing-model.png){fit="contain" position="center" max-height="46vh"}
...
![分布式实时处理系统](./assets/figures/realtime-system-architecture.png){fit="contain" position="center" max-height="56vh"}
